...
class Lesson {
  ...
  List<WrittenExercise> writtenExercises;
  ...
  Lesson({
    ...
    required this.writtenExercises,
  });
  ...
  factory Lesson.fromJson(Map<String, dynamic> json, {String? id}) {
    ...
    List<WrittenExercise> writtenExercisesList = writtenExercisesFromJson
        .map((we) => WrittenExercise.fromJson(we))
        .toList();
    ...
    return Lesson(
      ...
      writtenExercises: writtenExercisesList,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'writtenExercises': writtenExercises.map((we) => we.toJson()).toList(),
    };
  }
}
